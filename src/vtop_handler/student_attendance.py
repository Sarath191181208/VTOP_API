...
from vtop_handler.constants import HEADERS, VTOP_ATTENDANCE_URL, SEM_IDS
from vtop_handler.payloads import get_vtop_attendance_payload
from vtop_handler.parsers import parse_attendance

...
VTOP_SINGLE_SUBJECT_ATTENDANCE_URL = (
    r"https://vtop2.vitap.ac.in/vtop/processViewAttendanceDetail"
)
VTOP_TIMETABLE_URL = r"https://vtop2.vitap.ac.in/vtop/processViewTimeTable"
VTOP_ACADHISTORY_URL = (
    r"https://vtop2.vitap.ac.in/vtop/examinations/examGradeView/StudentGradeHistory"
)
VTOP_PROFILE_URL = (
    r"https://vtop2.vitap.ac.in/vtop/studentsRecord/StudentProfileAllView"
)
VTOP_MARKS_URL = r"https://vtop2.vitap.ac.in/vtop/examinations/doStudentMarkView"
VTOP_EXAM_SCHEDULE_URL = (
    r"https://vtop2.vitap.ac.in/vtop/examinations/doSearchExamScheduleForStudent"
)
...
COURSE_PAGE_GET_CONTENT_URL = (
    r"https://vtop2.vitap.ac.in/vtop/processViewStudentCourseDetail"
)

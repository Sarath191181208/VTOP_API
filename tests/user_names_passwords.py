...
for i in [USERNAME, PASSWORD,
          ...
          FRESHER_USERNAME_1, FRESHER_PASSWORD_1, VTOP_USERNAME_2, VTOP_PASSWORD_2]:
...
def merge_username_passwords(args: List[Tuple[str, str]],
            extended_args: Union[List[Union[List, Tuple, Any]], None]) -> List:
    """
